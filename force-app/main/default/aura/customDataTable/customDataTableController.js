({
    ...
    handleCustomPopover : function(component, event, helper) {
        // first hide all opened popover
        for (var popover of document.getElementsByClassName("custom-popover-wrapper")) {
            popover.style.display = "none";
        }
        
        // show current popover
        var lookupId = event.target.getAttribute('data-id');
        var el = document.getElementById(lookupId);
    ...
    //                     body: content, 
    //                     referenceSelector: "." + cssClass,
    //                     cssClass: "slds-nubbin_right,slds-popover_walkthrough,no-pointer,rich-popover"
    ...
    hideCustomPopover : function(component, event, helper) {
